...
Расширяет оригинальный цифровой CMOS-маршрут до **BJT, BiCMOS, резисторов, конденсаторов, диодов** — экстракция на уронвне отдельных транзисторов с экспортом нетлиста SPICE/CDL/Spectre.
...
Электрические приницпиальные схемы на уровне транзисторов и функциональные блок-диаграммы (для floorplan иерархии) из SPICE-нетлиста.
